...
CATEGORY_PAGES_DESCRIPTIONS = {
    ...
    "ru": {
        "Литература и поэзия"   : "Стихи, которые мне нравятся и не только стихи",
        "Политика"  : "Мысли о политике в России и не только",
        "Программирование"  : "Всё что связано с программированием (в основном {Python}) и IT",
        "Научные статьи"    :   "Интересные научные статьи, то что стоит почитать любому мыслящему человеку",
        "Разное"    :   "Всё, что не поддается каталогизации и категоризации:)"
...
#     ("icon", "/favicon.ico", "16x16"),
    ("icon", "/images/site_images/megahardlab.ico", "66x66"),
)
